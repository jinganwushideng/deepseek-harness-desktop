...
Security fixes currently target the latest GitHub prerelease.

## Reporting a vulnerability

Do not open a public Issue for suspected vulnerabilities, credential exposure, unsafe plugin execution, backup cryptography problems, or path traversal issues.
